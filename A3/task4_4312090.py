...
def apply_tsne(X, n_components, perplexity, max_iter, init, random_state=2024):
    ...
    pipline = make_pipeline(
        StandardScaler(),
        TSNE(n_components=n_components, max_iter=max_iter, perplexity=perplexity, init=init, random_state=random_state)
    )
...
if __name__ == "__main__":
    ...
    X_tsne_2d = apply_tsne(X, n_components=2, perplexity=30, max_iter=500, init='random', random_state=2024)
